...
//const invertedObject = Object.entries(object).map(([value, key]) => {key, value}));
//return invertedObject
// let invertedObject = [value, key];
// for (let invertedObject of Object.inver(object[key, value])){
//   if value === object){
//     return false
//   }
// }
...
// for (const value of Object.invert(object).keys().values()) {
//   if (object === object) {
//     return false
//   } else {
//     return invertedObject
...
function find(obj, matcherFunc) {
  ...
  // const value = obj(obj[i]);
  // if (obj <= matcherFunc) {
  //   return null
  // } else if (num >= matcherFunc) {
  //   return value
}
